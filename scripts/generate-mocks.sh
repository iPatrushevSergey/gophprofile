...
gen app/internal/server/avatar/application/port/logger.go app/internal/server/avatar/application/port/mocks/mock_logger.go
...
gen app/internal/processor/processing/application/port/image_resizer.go app/internal/processor/processing/application/port/mocks/mock_image_resizer.go
...
gen app/internal/processor/processing/application/port/logger.go app/internal/processor/processing/application/port/mocks/mock_logger.go
