...
// Source: app/internal/pkg/port/logger.go
//
// Generated by this command:
//
//	mockgen -source=app/internal/pkg/port/logger.go -destination=app/internal/pkg/port/mocks/mock_logger.go -package=mocks
//
